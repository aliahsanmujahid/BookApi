...
using BookApiNew.Data;
using BookApiNew.Models;
using BookApiNew.Repository.IRepository;
using System;
using System.Collections.Generic;
using System.Linq;
using System.Threading.Tasks;

namespace BookApiNew.Repository
{
    public class ReviewerRepository : IReviewerRepository
    {
        private DataContext _reviewerContext;

        public ReviewerRepository(DataContext reviewerContext)
        {
